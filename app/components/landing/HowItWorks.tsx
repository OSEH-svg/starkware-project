      ...
      <div className="container px-4 relative z-10 flex flex-col items-center">
        <div className="text-center mb-16 max-w-4xl">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto text-lg font-light">
            Connect your wallet, choose a market, and trade perpetuals
            instantly.
          </p>
        </div>
        ...
        <div className="relative h-[600px] hidden md:block w-full max-w-[1200px] mx-auto">
            ...
            >
              ...
              <defs>
                ...
                >
                  ...
                  <feGaussianBlur
                    stdDeviation="22"
                    result="effect1_foregroundBlur_20_189"
                  />
                </filter>
              </defs>
            </svg>
          ...
          >
            <div className="relative mb-4">
              <span
                ...
                style={{
                  background:
                    "linear-gradient(180deg, #7C7EFF 0%, #313151 100%)",
            ...
            <p className="text-gray-400 text-sm relative z-10">
              Connect your Argent or Braavos wallet. No registration required.
            </p>
          </motion.div>
          <motion.div
          ...
          >
            <Image
              ...
              width={100}
              height={100}
              className="w-30 h-30 drop-shadow-[0_0_15px_rgba(124,126,255,0.3)]"
            />
          </motion.div>
          ...
          >
            ...
            <h3 className="text-xl font-bold text-white mb-2 relative z-10 pt-10 text-left">
              Trade
            </h3>

            <p className="text-gray-400 text-sm relative z-10 text-left">
              Browse diverse markets. Access real-time pricing, deep liquidity,
              and advanced charting tools to make informed decisions.
            </p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-xl font-bold text-white mb-2 relative z-10 text-left">
              Earn
            </h3>
            <p className="text-gray-400 text-sm relative z-10 text-left">
              Place your trades with one-click execution. Monitor positions in
              real-time, and manage risk with advanced order types
            </p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, scale: 0.8 }}
        ...
        <div className="grid md:hidden gap-12 relative w-full h-[800px]">
          ...
          <div className="flex flex-col justify-between h-full py-20">
            <MobileStep
              ...
              text="Connect your Argent or Braavos wallet. No registration required."
              imgSrc="/icons/Group 5.png"
            />
            <MobileStep
              number="2"
              title="Trade"
              text="Browse diverse markets. Access real-time pricing, deep liquidity, and advanced charting tools to make informed decisions."
              imgSrc="/icons/Group 6.png"
            />
            <MobileStep
              number="3"
              title="Earn"
              text=" Place your trades with one-click execution. Monitor positions in
              real-time, and manage risk with advanced order types."
