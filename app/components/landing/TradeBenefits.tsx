...
const BENEFITS = [
  {
    ...
    description:
      "Experience lightning-fast and one-click trading with diverse markets, deep liquidity, and advanced order types. Tap into the power of decentralized finance with Perpify.",
    icon: "/icons/Fast.svg",
    badge: "Seamless & powerful",
  },
  {
    title: "True Decentralisation",
    description:
      "Built on Starknet's zero-knowledge rollup technology and powered by Extended Protocol, Perpify gives you complete control without intermediaries. Trade with confidence knowing every transaction is transparent, verifiable, and censorship-resistant.",
    icon: "/icons/Safe.svg",
    badge: "True Decentralisation",
  },
  {
    title: "Built for Performance",
    description:
      "Perpify delivers sub-second trade confirmations and gas costs that won't eat your profits. Real-time position monitoring, and instant order updates mean you stay focused on what matters: your trades.",
    icon: "/icons/box.svg",
    ...
    <section className="py-24 px-4 lg:px-48 relative overflow-hidden bg-black">
      ...
      <div className="flex flex-col items-start mb-20">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-end w-full gap-8">
          ...
          >
            Experience lightning-fast execution with one-click trading across
            diverse markets.
          </motion.p>
        </div>
      </div>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at center, rgba(124, 126, 255, 0.1) 0%, transparent 70%)",
        }}
      />

      <div className="relative z-10">
        <div
          className="inline-flex items-center px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-sm text-gray-300 mb-6"
          style={{
